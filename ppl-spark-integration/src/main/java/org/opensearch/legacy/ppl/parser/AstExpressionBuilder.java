...
package org.opensearch.legacy.ppl.parser;
...
import org.opensearch.legacy.ast.expression.AggregateFunction;
import org.opensearch.legacy.ast.expression.Alias;
import org.opensearch.legacy.ast.expression.AllFields;
import org.opensearch.legacy.ast.expression.And;
import org.opensearch.legacy.ast.expression.Argument;
import org.opensearch.legacy.ast.expression.AttributeList;
import org.opensearch.legacy.ast.expression.Between;
import org.opensearch.legacy.ast.expression.Case;
import org.opensearch.legacy.ast.expression.Cast;
import org.opensearch.legacy.ast.expression.Cidr;
import org.opensearch.legacy.ast.expression.Compare;
import org.opensearch.legacy.ast.expression.DataType;
import org.opensearch.legacy.ast.expression.EqualTo;
...
import org.opensearch.legacy.ast.expression.Interval;
import org.opensearch.legacy.ast.expression.IntervalUnit;
import org.opensearch.legacy.ast.expression.IsEmpty;
import org.opensearch.legacy.ast.expression.LambdaFunction;
import org.opensearch.legacy.ast.expression.Let;
import org.opensearch.legacy.ast.expression.Literal;
import org.opensearch.legacy.ast.expression.Not;
import org.opensearch.legacy.ast.expression.Or;
import org.opensearch.legacy.ast.expression.QualifiedName;
import org.opensearch.legacy.ast.expression.Span;
import org.opensearch.legacy.ast.expression.SpanUnit;
import org.opensearch.legacy.ast.expression.UnresolvedArgument;
import org.opensearch.legacy.ast.expression.UnresolvedExpression;
import org.opensearch.legacy.ast.expression.When;
import org.opensearch.legacy.ast.expression.Xor;
import org.opensearch.legacy.ast.expression.subquery.ExistsSubquery;
import org.opensearch.legacy.ast.expression.subquery.InSubquery;
import org.opensearch.legacy.ast.expression.subquery.ScalarSubquery;
import org.opensearch.legacy.common.utils.StringUtils;
import org.opensearch.legacy.ppl.utils.ArgumentFactory;
...
import static org.opensearch.legacy.expression.function.BuiltinFunctionName.EQUAL;
...
import static org.opensearch.legacy.expression.function.BuiltinFunctionName.POSITION;

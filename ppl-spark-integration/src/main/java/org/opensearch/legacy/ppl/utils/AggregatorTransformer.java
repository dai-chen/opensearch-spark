...
public interface AggregatorTransformer {
    ...
    static Expression aggregator(AggregateFunction aggregateFunction, Expression arg) {
    ...
    private static double getPercentDoubleValue(AggregateFunction aggregateFunction) {
        ...
        org.opensearch.legacy.ast.expression.Literal percentIntValue = ((Argument) aggregateFunction.getArgList().get(0)).getValue();
